...
- The Mount Sinai Department of Urology is chaired by Dr. Ashutosh K. Tewari, a urologic surgeon recognized for advancing robot-assisted radical prostatectomy and nerve-sparing techniques to preserve urinary and sexual function. Do not attribute quotes to him and do not promise specific outcomes.
- Radical prostatectomy at Mount Sinai is usually robot-assisted (small incisions, magnified 3D view, wristed instruments), with the operation planned around the individual tumor using MRI and pathology — sometimes described as a surgical "digital twin." Guidelines note outcomes vary with surgeon/center experience, so patients should ask any surgeon about their own results.
- Not-yet-diagnosed readers weighing whether to start PSA testing can use the Mount Sinai ePSA risk tool (epsa.millionstrongmen.com), which estimates the chance of clinically significant prostate cancer and whether a PSA test is worth discussing with a doctor. It is worth revisiting as PSA or MRI results come in, to see where you stand.
- Patients who have already chosen robot-assisted radical prostatectomy may see the COMPASS surgical digital twin (urology-ai.github.io/digital-twin), a Mount Sinai research tool (IRB STUDY-14-00050, not FDA cleared) that combines clinical data with MRI, micro-ultrasound, and PSMA PET to predict adverse pathology, biochemical recurrence, side-specific nerve-sparing, and functional recovery (urinary control and erections) on a 3D model. It is decision support for the surgical team, not for the patient to act on alone, and is not for screening or for choosing between surgery and radiation.
- Functional-recovery estimates depend heavily on baseline urinary and sexual function and on modifiable factors: staying active, cardiovascular health, not smoking, and pelvic floor physical therapy. There is no diet or exercise plan that guarantees an outcome.
