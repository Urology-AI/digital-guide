...
const EN = {
  ...
  "nav.home": "Home",
  "nav.explore": "Explore care",
  "nav.ask": "Urology Copilot",
  "nav.questions": "Questions to ask",
  "nav.risk": "Risk factors",
  "nav.imaging": "Imaging",
  "lang.note": "Interface only — medical content is in English",
...
const ES: Partial<Dict> = {
  ...
  "nav.home": "Inicio",
  "nav.explore": "Explorar la atención",
  "nav.ask": "Urology Copilot",
  "nav.questions": "Preguntas para su médico",
  "nav.risk": "Factores de riesgo",
  "nav.imaging": "Imágenes",
  "lang.note": "Solo la interfaz — el contenido médico está en inglés",
...
const HI: Partial<Dict> = {
  ...
  "nav.home": "होम",
  "nav.explore": "देखभाल देखें",
  "nav.ask": "Urology Copilot",
  "nav.questions": "डॉक्टर के लिए प्रश्न",
  "nav.risk": "जोखिम कारक",
  "nav.imaging": "इमेजिंग",
  "lang.note": "केवल इंटरफ़ेस — चिकित्सा सामग्री अंग्रेज़ी में है",
